...
benchmark_train = dummy_model.create_nengo_data(
    mturk['train'], n_steps=1, itemize=True)
benchmark_test = dummy_model.create_nengo_data(
    mturk['test'], n_steps=1, itemize=True)
